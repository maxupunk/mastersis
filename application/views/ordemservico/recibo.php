...
<div class="modal-header"><h4 class="modal-title">RECEBO DE PRODUTO(S)/SERVIÇO(S)</h4></div>
<div class="modal-body impresao">
    ...
    <div class="recibo">
        ...
        <p class="miniletras">     
            1 - Os produtos listados neste recibo foram entregues ao receptor conforme descritos.<br>
            2 - O cliente conferiu todas as mercadorias durante a baixa.<br>
            3 - O Cliente acompanhou e reconheceu os produtos listados, bem como suas respectivas quantidades e valores.<br>
