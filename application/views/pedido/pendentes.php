            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    <div class="pull-right">
                        <a href="pedido/receber/<?php echo $linha->PEDIDO_ID ?>" data-toggle="modal" data-target="#Modal" class="btn-xs btn-success">Receber</a>
                        <a href="compras/abrir/<?php echo $linha->PES_ID ?>" id="EditaPedido" class="btn-xs btn-warning">Alterar</a>
                        <a href="pedido/Delete/<?php echo $linha->PEDIDO_ID ?>" data-toggle="modal" data-target="#Modal" class="btn-xs btn-danger">Canselar</a>
                    </div>
