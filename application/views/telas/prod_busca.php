...
foreach ($query as $linha) {
    ...
    $this->table->add_row($linha->PRO_ID, $estatus." ".$tipo, anchor("produto/editar/$linha->PRO_ID", '<span class="glyphicon glyphicon-edit"></span>') . ' ' . anchor("produto/excluir/$linha->PRO_ID", '<span class="glyphicon glyphicon-trash"></span>') . ' ' . anchor("produto/exibir/$linha->PRO_ID", '<span class="glyphicon glyphicon-list-alt"></span>') . ' ' . anchor("produto/imagem/$linha->PRO_ID", '<span class="glyphicon glyphicon-picture"></span>'));
}
