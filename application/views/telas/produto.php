                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="btn-group" id="sub_menu">
                            <button class="btn btn-default" url="<?php echo base_url('produto'); ?>/cadastrar">Cadastro</button>
                            <button class="btn btn-default" url="<?php echo base_url('produto'); ?>/listar">Lista todos</button>
                        </div>
                    </div>
