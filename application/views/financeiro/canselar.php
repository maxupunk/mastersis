...
?>
<form action="<?php echo base_url('financeiro'); ?>/canselar/<?php echo $query->DESREC_ID ?>" method="post" id="SubmitAjax" accept-charset="utf-8">
    <fieldset>
...
<?php } ?>
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-danger">Comfirma o canselamento</button>
            <button type="button" class="btn btn-default" data-dismiss="modal">Não canselar</button>
        </div>
