...
-- -----------------------------------------------------
-- Table `sgc`.`LISTA_SERVICO`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `sgc`.`LISTA_SERVICO` (
  `LIST_SRV_ID` INT NOT NULL AUTO_INCREMENT ,
  `SERV_ID` INT NOT NULL ,
  `OS_ID` INT NOT NULL ,
  `LIST_SRV_QNT` INT NOT NULL ,
  `LIST_SRV_PRECO` DECIMAL(10,2) NOT NULL ,
